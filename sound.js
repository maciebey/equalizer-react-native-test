...
var RNSound = ReactNative.NativeModules.RNSoundModule;
...
Sound.prototype.bands = function(callback) {
  if (this._loaded) {
    RNSound.bands(this._key, (res) => {
...
Sound.prototype.setBandLevel = function(bandNumber, change, callback) {
  if (this._loaded) {
    RNSound.setBandLevel(this._key, bandNumber, change, (res) => {
      callback && callback(res);
    });
  }
  return this;
